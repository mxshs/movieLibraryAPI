...
type Actor struct {
	...
	Birthdate time.Time `json:"birthdate" example:"11.11.1974" format:"date"`
}
...
type Movie struct {
	...
	ReleaseDate time.Time `json:"release_date" example:"25.12.2013" format:"date" validate:"required"`
